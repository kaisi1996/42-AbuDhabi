...
void largeInput_insert(Span& sp, std::vector<int>::iterator begin, std::vector<int>::iterator end)
{
	try
	{
...
void my_tests() 
{
    ...
    largeInput_insert(spanExactFit, numbersToFit.begin(), numbersToFit.end());
    std::cout << "testing on : ";
	spanExactFit.printVec();
    ...
    largeInput_insert(spanExceed, tooManyNumbers.begin(), tooManyNumbers.end());
	std::cout << std::endl;
	...
	numbersForCalc.push_back(100);
    largeInput_insert(spanCalc, numbersForCalc.begin(), numbersForCalc.end());
	std::cout << "testing on : ";
	spanCalc.printVec();
    span_wrapper(spanCalc);
	std::cout << std::endl;
    ...
    span_wrapper(identicalNumbersSpan);
	std::cout << std::endl;
	...
	largeInput_insert(BigSpan, BigVec.begin(), BigVec.end());
	std::cout << "testing on "<< BigVec.size() <<" numbers range: [" << *std::min_element(BigVec.begin(), BigVec.end()) << "] ... [" << *std::max_element(BigVec.begin(), BigVec.end()) <<"]\n";
